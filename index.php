...
<html lang="zxx">
   <head>
      <title>EXPERT SYSTEM FOR DIAGNOSIS AND PRESCRIPTION OF BREAST CANCER</title>
      <!--meta tags -->
      <meta charset="UTF-8">
      <meta name="viewport" content="width=device-width, initial-scale=1">
      <meta name="keywords" content="EXPERT SYSTEM FOR DIAGNOSIS AND PRESCRIPTION OF BREAST CANCER" />
      <script>
   ...
   <body>
            ...
            <div class="container-fluid">
               <div class="hedder-up row">
                  <div class="col-lg-3 col-md-3 logo-head">
                     <h1><a class="navbar-brand" href="index.html">EXPERT SYSTEM FOR DIAGNOSIS AND PRESCRIPTION OF BREAST CANCER SYSTEM</a></h1>
                  </div>
               </div>
            </div>
            <nav class="navbar navbar-expand-lg navbar-light">
               ...
               <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                  <ul class="navbar-nav ">
                    ...
                    <li class="nav-item">
                        <a href="reg.php" class="nav-link">Create Account</a>
                     </li>
                     <li class="nav-item">
                     ...
                     <div class="slider-img one-img">
                        <div class="container">
                           <div class="slider-info ">
                              <h5>Welcome <br>to EXPERT SYSTEM FOR DIAGNOSIS AND PRESCRIPTION OF BREAST CANCER System</h5>
                              <div class="bottom-info">
                                 <p>Diagnosing to know your health status</p>
                              </div>
                           </div>
                        </div>
                     </div>
      ...
      <footer class="py-lg-4 py-md-3 py-sm-3 py-3 text-center">
         <div class="copy-agile-right">
            <p> 
               EXPERT SYSTEM FOR DIAGNOSIS AND PRESCRIPTION OF BREAST CANCER SYSTEM
            </p>
         </div>
      </footer>
      <!-- //footer -->
